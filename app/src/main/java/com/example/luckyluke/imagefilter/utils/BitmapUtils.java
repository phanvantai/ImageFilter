package com.example.luckyluke.imagefilter.utils;
...
public class BitmapUtils {
    ...
    /**
     * Storing image_dark to device gallery
     * @param cr
     * @param source
     * @param title
     * @param description
    ...
    public static final String insertImage(ContentResolver cr,
        ...
        // Add the date meta data to ensure the image_dark is added at the front of the gallery
